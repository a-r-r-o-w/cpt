...
class CustomMarkdownConverter(markdownify.MarkdownConverter):
    def convert_a(self, el: bs4.BeautifulSoup, text: str, convert_as_inline: bool) -> str:
        href = el.get("href")
        return f"[{text}]({href})"

    def convert_em(self, el: bs4.BeautifulSoup, text: str, convert_as_inline: bool) -> str:
        return f"*{text}*"
