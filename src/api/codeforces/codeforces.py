...
from cfobject import (
  Member, Party, Problem,
  ProblemStatistic, ProblemResult, Submission,
  User, BlogEntry, Comment,
  RecentAction, Contest, RatingChange,
  Hack, RanklistRow,
  member_parse, party_parse, problem_parse,
  problemstatistic_parse, problemresult_parse, submission_parse,
  user_parse, blogentry_parse, comment_parse,
  recentaction_parse, contest_parse, ratingchange_parse,
  hack_parse, ranklistrow_parse
)
...
class CodeforcesAPI:
  ...
  async def blogentry_view (
    self, *,
    blogentry_id: int
  ) -> typing.List[BlogEntry]:
...
def main ():
  async def async_main ():
    ...
    contest_standings = await API.contest_standings(contest_id = 1642, handles = ['4rrow'])
